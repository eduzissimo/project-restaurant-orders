...
<details>
  ...
  * Data para entrega no prazo regular: `26/06/2024 23:59`.
...
<details>
  ...
  - Use o comando: `git clone git@github.com:tryber/sd-036-restaurant-orders.git`.
  ...
  - Crie uma branch à qual você vai submeter os `commits` do seu projeto
    ...
    - Exemplo: `git checkout -b joaozinho-sd-036-restaurant-orders`
  ...
  - Usando o exemplo anterior: `git push -u origin joaozinho-sd-036-restaurant-orders`

  7. Crie um novo `Pull Request` _(PR)_

  - Vá até a página de _Pull Requests_ do [repositório no GitHub](https://github.com/tryber/sd-036-restaurant-orders/pulls)
  ...
  - Volte até a [página de _Pull Requests_ do repositório](https://github.com/tryber/sd-036-restaurant-orders/pulls) e confira que o seu _Pull Request_ está criado
...
[FORMULÁRIO DE AVALIAÇÃO DE PROJETO](https://be-trybe.typeform.com/to/ZTeR4IbH#cohort_hidden=CH36&template=betrybe/sd-0x-restaurant-orders)
